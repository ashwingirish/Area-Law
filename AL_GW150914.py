...
def waveform_model(time_array, mass_1, mass_2, luminosity_distance, theta_jn, phase,a_1, a_2, tilt_1=0.0, tilt_2=0.0, phi_12=0.0, phi_jl=0.0, **waveform_kwargs):
...
result = bilby.run_sampler(likelihood, prior, sampler="dynesty", nlive=100, npoints=1000, sample='unif',
